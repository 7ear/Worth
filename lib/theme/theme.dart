...
final theme = ThemeData(
  ...
  textTheme: TextTheme(
    titleLarge: TextStyle(fontSize: 32, fontWeight: FontWeight.w600, color: Color.fromRGBO(248, 248, 255, 1)),
    displayLarge: TextStyle(fontSize: 19, fontWeight: FontWeight.w500, color: Color.fromRGBO(237, 237, 237, 1)),
    ...
    headlineSmall: TextStyle(fontSize: 20, fontWeight: FontWeight.w400, color: Color.fromRGBO(193, 193, 193, 1)),
    ...
    titleSmall: TextStyle(fontSize: 13, fontWeight: FontWeight.w400, color: Color.fromRGBO(255, 255, 255, 0.62)),
  ),
);
